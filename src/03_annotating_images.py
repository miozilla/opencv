...
cv2.line(imageLine, (550, 150), (650, 500), (200, 100, 50), thickness=5, lineType=cv2.LINE_AA);
cv2.line(imageLine, (650, 150), (550, 500), (20, 10, 250), thickness=5, lineType=cv2.LINE_AA);
...
cv2.circle(imageCircle, (655,155), 10, (50, 50, 255), thickness=5, lineType=cv2.LINE_AA);
...
cv2.rectangle(imageRectangle, (600, 100), (700, 550), (255, 50, 255), thickness=5, lineType=cv2.LINE_8)
...
imageText = image.copy()
text = "Let's go to the Moon!!! Oct 10, 2025"
fontScale = 2.3
fontFace = cv2.FONT_HERSHEY_PLAIN
fontColor = (0, 255, 0)
fontThickness = 2

cv2.putText(imageText, text, (285, 700), fontFace, fontScale, fontColor, fontThickness, cv2.LINE_AA);
